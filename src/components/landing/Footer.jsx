      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="text-center md:text-right">
              ...
              <div className="flex gap-2">
                ...
                />
                <button className="px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg font-semibold hover:shadow-lg transition-all duration-300">
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={scrollToTop}
              className="w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center hover:scale-110 transition-transform"
            >
